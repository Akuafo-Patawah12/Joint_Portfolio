      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 text-sm"
          />
        </div>
        <div>
          <label style={{marginBlock:"4px"}} className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <button
          type="submit"
          className="w-full bg-green-500 text-gray-800 py-2 rounded-lg hover:bg-green-700 transition text-sm font-semibold"
        >
    ...
    <div>
      ...
      <div style={{marginBlock:"24px"}} className="mt-6">
        ...
        <div className="flex gap-4 flex-wrap">
          <a href="https://www.facebook.com/AkuafoPatawah" target="_blank" className="flex gap-2 justify-center items-center text-sm p-[6px] border border-stone-200 rounded-2xl hover:text-purple-800 transition">
